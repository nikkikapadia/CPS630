export const dummyDataForAcademicServices = [
  {
    adTitle: "Professional Photography Sessions",
    description:
    ...
    price: "75",
    location: "Mississauga, ON L5B 4C1",
  },
  {
    adTitle: "Resume, Cover Letter & Career Guidance",
    description:
    ...
    price: "50",
    location: "East York, ON M4B 1B3",
  },
  {
    adTitle: "Calculus Tutoring for University Students",
    description:
    ...
    price: "40",
    location: "Scarborough, ON M1P 4N7",
  },
  {
    adTitle: "Professional Barber Services - Fades & Tapers",
    description:
    ...
    price: "30",
    location: "Etobicoke, ON M8V 1A5",
  },
  {
    adTitle: "Personal Trainer & Physical Fitness Coach",
    description:
