...
function MyPosts() {
  ...
  const fetchPosts = async () => {
    let ads = [];
    await fetch(`https://cps630.onrender.com/api/ads/get/itemsWanted/author/${user.username}`, {
      method: "GET",
      headers: {
      ...
      .then((data) => {
        ...
        ads.push(...temp);
        return fetch(`https://cps630.onrender.com/api/ads/get/itemsForSale/author/${user.username}`, {
          method: "GET",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
      ...
      .then((data) => {
        ...
        ads.push(...temp);
        return fetch(`https://cps630.onrender.com/api/ads/get/academicServices/author/${user.username}`, {
          method: "GET",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
